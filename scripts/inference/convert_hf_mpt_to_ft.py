...
def convert_mpt_to_ft(
    ...
    try:
        config["gpt"]["model_name"] = (
            "mpt" if hf_config["_name_or_path"] == "" else hf_config["_name_or_path"]
        )
        ...
        config["gpt"]["start_id"] = (
            str(hf_config["bos_token_id"])
            if hf_config["bos_token_id"] != None
            else str(tokenizer.bos_token_id)
        )
        config["gpt"]["end_id"] = (
            str(hf_config["eos_token_id"])
            if hf_config["eos_token_id"] != None
            else str(tokenizer.eos_token_id)
        )
