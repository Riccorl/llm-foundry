...
#SBATCH -o logs/encodo-350m-7B_it-7B_en-cx-21022024/train-4nodes-job.out       # Name of stdout output file
#SBATCH -e logs/encodo-350m-7B_it-7B_en-cx-21022024/train-4nodes-job.err       # Name of stderr error file
...
srun ./scripts/slurm/encodo-350m-7B_it-7B_en-cx-21022024/train_multinode.sh
