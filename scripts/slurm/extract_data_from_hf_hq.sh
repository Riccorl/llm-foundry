...
~/__Work/llmfoundry-cuda-flash-attn2-env/bin/python /leonardo/home/userexternal/lmoroni0/__Work/llm-foundry/scripts/data_prep/extract_hf_to_jsonl_hq.py \
    ...
    --path_to_save /leonardo_work/IscrB_medit/culturax_res/reservoir_hq_85M/en/ \
    --split_size 500_000 --max_iterations 85_000_000 --ds_split train \
    --sources mC4 OSCAR-2301 OSCAR-2201

#~/__Work/llmfoundry-cuda-flash-attn2-env/bin/python /leonardo/home/userexternal/lmoroni0/__Work/llm-foundry/scripts/data_prep/extract_hf_to_jsonl_hq.py \
    # --dataset_path /leonardo/prod/data/ai/culturax/2309/it \
    # --path_to_save /leonardo_work/IscrB_medit/culturax_res/reservoir_hq_85M/it/ \
    # --split_size 500_000 --max_iterations 85_000_000 --ds_split train \
    # --sources mC4 OSCAR-2301 OSCAR-2201
