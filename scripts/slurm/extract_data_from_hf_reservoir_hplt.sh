...
~/__Work/llmfoundry-cuda-flash-attn2-env/bin/python /leonardo/home/userexternal/lmoroni0/__Work/llm-foundry/scripts/data_prep/extract_hf_to_jsonl_reservoir.py \
    ...
    --path_to_save /leonardo_work/IscrB_medit/hplt_res/reservoir_sample_10M_80M/en/ \
    --max_samples 10_000_000 --split_size 50_000 --max_iterations 53_520_000 --ds_split train \


# ~/__Work/llmfoundry-cuda-flash-attn2-env/bin/python /leonardo/home/userexternal/lmoroni0/__Work/llm-foundry/scripts/data_prep/extract_hf_to_jsonl_reservoir.py \
#     --dataset_path /leonardo/prod/data/ai/hplt-datasets/1.2/it \
#     --path_to_save /leonardo_work/IscrB_medit/hplt_res/reservoir_sample_10M_80M/it/ \
#     --max_samples 10_000_000 --split_size 500_000 --max_iterations 53_520_000 --ds_split train
