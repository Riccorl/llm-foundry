...
#SBATCH -o logs/minestral-100m-1B_it-1B_en-cx-06022024/extract_for_tokenizer-job.out              # Name of stdout output file
#SBATCH -e logs/minestral-100m-1B_it-1B_en-cx-06022024/extract_for_tokenizer-job.err              # Name of stderr error file
...
~/llmfoundry-cuda-flash-attn2-env/bin/python \
    ...
    --file_to_save $SCRATCH/data/minestral-100m-1B_it-1B_en-cx-06022024/data/tokenizer/en.txt \
    --max_samples 850_000

~/llmfoundry-cuda-flash-attn2-env/bin/python \
    /leonardo/home/userexternal/rorland1/llm-foundry/scripts/data_prep/extract_txt_for_tokenizer.py \
    --data_folder $WORK/culturax_res/reservoir_sample_10M_100M/it/web \
    --file_to_save $SCRATCH/data/minestral-100m-1B_it-1B_en-cx-05022024/data/tokenizer/it.txt \
    --max_samples 850_000
