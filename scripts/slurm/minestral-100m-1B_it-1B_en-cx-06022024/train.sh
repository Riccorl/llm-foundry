#!/bin/bash
#SBATCH --job-name=minestral-100m-1B_it-1B_en-cx-06022024-train            # Job name
#SBATCH -o logs/minestral-100m-1B_it-1B_en-cx-06022024/train-job.out       # Name of stdout output file
#SBATCH -e logs/minestral-100m-1B_it-1B_en-cx-06022024/train-job.err       # Name of stderr error file
...
composer scripts/train/train.py scripts/train/yamls/pretrain/minestral-100m-1B_it-1B_en-cx-06022024.yaml
