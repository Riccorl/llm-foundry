#!/bin/bash
#SBATCH --job-name=minestral-1B-100B_it-100B_en-cx-04032024-data-en  # Job name
#SBATCH -o logs/minestral-1B-100B_it-100B_en-cx-04032024/data_prep-en.out              # Name of stdout output file
#SBATCH -e logs/minestral-1B-100B_it-100B_en-cx-04032024/data_prep-en.err              # Name of stderr error file
...
~/llmfoundry-cuda-flash-attn2-env/bin/python scripts/data_prep/convert_dataset_hf.py \
    ...
    --out_root /leonardo_scratch/large/userexternal/rorland1/data/minestral-1B-100B_it-100B_en-cx-04032024/data/processed/en \
