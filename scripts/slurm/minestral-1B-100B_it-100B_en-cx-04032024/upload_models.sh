#!/bin/bash
#SBATCH --job-name=minestral-3B-165B_it-330B_en-cx-13042024-upload            # Job name
#SBATCH -o logs/minestral-3B-165B_it-330B_en-cx-13042024/upload-job.out       # Name of stdout output file
#SBATCH -e logs/minestral-3B-165B_it-330B_en-cx-13042024/upload-job.err       # Name of stderr error file
...
bash scripts/inference/upload_checkpoints_hf_hub.sh \
    /leonardo_scratch/large/userexternal/rorland1/llm-foundry/runs/minestral-1B-100B_it-100B_en-cx-04032024 \
