#!/bin/bash
#SBATCH --job-name=minestral-350m-7B_it-7B_it-cx-eval-13022024    # Job name
#SBATCH -o logs/minestral-350m-7B_it-7B_en-cx-13022024/data_prep-it-eval-job.out              # Name of stdout output file
#SBATCH -e logs/minestral-350m-7B_it-7B_en-cx-13022024/data_prep-it-eval-job.err              # Name of stderr error file
...
~/llmfoundry-cuda-flash-attn2-env/bin/python scripts/data_prep/convert_dataset_json.py \
    ...
    --out_root /leonardo_scratch/large/userexternal/rorland1/data/minestral-350m-7B_it-7B_en-cx-13022024/data/processed/it/eval \
