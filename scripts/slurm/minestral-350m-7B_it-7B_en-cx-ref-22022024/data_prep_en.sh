#!/bin/bash
#SBATCH --job-name=minestral-350m-7B_it-7B_en-cx-ref-22022024    # Job name
#SBATCH -o logs/minestral-350m-7B_it-7B_en-cx-ref-22022024/data_prep-en-7B-job.out              # Name of stdout output file
#SBATCH -e logs/minestral-350m-7B_it-7B_en-cx-ref-22022024/data_prep-en-7B-job.err              # Name of stderr error file
...
~/llmfoundry-cuda-flash-attn2-env/bin/python scripts/slurm/minestral-350m-7B_it-7B_en-cx-ref-22022024/filter_refs.py \
    --path /leonardo_scratch/large/userexternal/lmoroni0/datasets/culturax_res/reservoir_sample_10M_100M/en/web-refs \
    --out_root /leonardo_scratch/large/userexternal/rorland1/data/culturax/web-refs/en \

~/llmfoundry-cuda-flash-attn2-env/bin/python scripts/data_prep/convert_dataset_json.py \
    --path /leonardo_scratch/large/userexternal/rorland1/data/culturax/web-refs/en \
    --out_root /leonardo_scratch/large/userexternal/rorland1/data/minestral-350m-7B_it-7B_en-cx-ref-22022024/data/processed/en/train \
