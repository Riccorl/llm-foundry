#!/bin/bash
#SBATCH --job-name=minestral-350m-7B_it-7B_it-31-100-4B-hplt-09022024    # Job name
#SBATCH -o logs/minestral-350m-7B_it-7B_en-hplt-09022024/data_prep-it-eval-job.out              # Name of stdout output file
#SBATCH -e logs/minestral-350m-7B_it-7B_en-hplt-09022024/data_prep-it-eval-job.err              # Name of stderr error file
...
# --data_files_pattern "(1[5-9])"
# --data_files_pattern "([0-9]|10)"

~/llmfoundry-cuda-flash-attn2-env/bin/python scripts/data_prep/convert_dataset_json.py \
    --path /leonardo_work/IscrB_medit/hplt_res/reservoir_sample_10M_53M/it/web \
    --data_files_pattern "19.jsonl" \
    --out_root /leonardo_scratch/large/userexternal/rorland1/data/minestral-350m-7B_it-7B_en-hplt-09022024/data/processed/it/eval \
