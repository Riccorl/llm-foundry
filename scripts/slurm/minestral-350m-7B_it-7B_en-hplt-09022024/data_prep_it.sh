#!/bin/bash
#SBATCH --job-name=minestral-350m-7B_it-7B_it-0-30-hplt-09022024    # Job name
#SBATCH -o logs/minestral-350m-7B_it-7B_en-hplt-09022024/data_prep-it-0-30-4B-job.out              # Name of stdout output file
#SBATCH -e logs/minestral-350m-7B_it-7B_en-hplt-09022024/data_prep-it-0-30-4B-job.err              # Name of stderr error file
...
~/llmfoundry-cuda-flash-attn2-env/bin/python scripts/data_prep/convert_dataset_json.py \
    ...
    --data_files_pattern "(\d|[12]\d|30).jsonl" \
    --out_root /leonardo_scratch/large/userexternal/rorland1/data/minestral-350m-7B_it-7B_en-hplt-09022024/data/processed/it/0-30-4B \
