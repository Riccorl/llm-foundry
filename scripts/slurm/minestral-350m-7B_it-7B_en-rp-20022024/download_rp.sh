#!/bin/bash
#SBATCH --job-name=minestral-350m-7B_it-7B_en-rp-20022024    # Job name
#SBATCH -o logs/minestral-350m-7B_it-7B_en-rp-20022024/download-job.out              # Name of stdout output file
#SBATCH -e logs/minestral-350m-7B_it-7B_en-rp-20022024/download-job.err              # Name of stderr error file
...
~/llmfoundry-cuda-flash-attn2-env/bin/python \
    /leonardo/home/userexternal/rorland1/llm-foundry/scripts/slurm/minestral-350m-7B_it-7B_en-rp-20022024/download_rp.py
...
#     --file_to_save $SCRATCH/data/minestral-350m-7B_it-7B_en-rp-20022024/data/tokenizer/en.txt \
#     --max_samples 1_900_000

# ~/llmfoundry-cuda-flash-attn2-env/bin/python \
#     /leonardo/home/userexternal/rorland1/llm-foundry/scripts/data_prep/extract_txt_for_tokenizer.py \
#     --data_folder $WORK/culturax_res/reservoir_sample_10M_100M/it/web \
#     --file_to_save $SCRATCH/data/minestral-350m-7B_it-7B_en-rp-20022024/data/tokenizer/it.txt \
#     --max_samples 1_900_000
