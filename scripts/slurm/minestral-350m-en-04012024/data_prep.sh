#!/bin/bash
#SBATCH --job-name=minestral-350m-en-04012024-data_prep-6B    # Job name
#SBATCH -o logs/minestral-350m-en-04012024/data_prep-6B-job.out              # Name of stdout output file
#SBATCH -e logs/minestral-350m-en-04012024/data_prep-6B-job.err              # Name of stderr error file
...
~/llmfoundry-cuda-flash-attn2-env/bin/python scripts/data_prep/convert_dataset_json.py \
    ...
    --out_root $WORK/llm-foundry/culturax/350M-model-6B-en/processed/en \
    --split train --concat_tokens 2048 --tokenizer $WORK/tokenizer/trained/minestreal350m-en-v2-hf \
