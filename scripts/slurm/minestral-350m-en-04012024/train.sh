...
#SBATCH -o logs/minestral-350m-en-04012024/train-fast-2-job.out       # Name of stdout output file
#SBATCH -e logs/minestral-350m-en-04012024/train-fast-2-job.err       # Name of stderr error file
