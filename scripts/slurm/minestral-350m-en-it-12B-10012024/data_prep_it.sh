#!/bin/bash
#SBATCH --job-name=minestral-350m-en-it-12B-10012024-data_prep-12B-it    # Job name
#SBATCH -o logs/minestral-350m-en-it-12B-10012024/data_prep-12B-it-job.out              # Name of stdout output file
#SBATCH -e logs/minestral-350m-en-it-12B-10012024/data_prep-12B-it-job.err              # Name of stderr error file
