...
NODE_RANK=0 srun composer scripts/train/train.py scripts/train/yamls/pretrain/minestral-350m-en-it.yaml
NODE_RANK=1 srun composer scripts/train/train.py scripts/train/yamls/pretrain/minestral-350m-en-it.yaml

# source ~/llmfoundry-cuda-flash-attn2-env/bin/activate

# python scripts/train/train.py scripts/train/yamls/pretrain/minestral-350m-en-it.yaml
