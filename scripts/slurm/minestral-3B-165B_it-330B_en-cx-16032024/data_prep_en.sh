#!/bin/bash
#SBATCH --job-name=minestral-3B-165B_it-330B_en-cx-16032024-data-en  # Job name
#SBATCH -o logs/minestral-3B-165B_it-330B_en-cx-16032024/data_prep-2048-en.out              # Name of stdout output file
#SBATCH -e logs/minestral-3B-165B_it-330B_en-cx-16032024/data_prep-2048-en.err              # Name of stderr error file
