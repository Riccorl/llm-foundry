#!/bin/bash
#SBATCH --job-name=minestral-350m-7B_it-7B_en-hq-cx-14022024    # Job name
#SBATCH -o logs/minestral-350m-7B_it-7B_en-hq-cx-14022024/data_prep-it-hq-job.out              # Name of stdout output file
#SBATCH -e logs/minestral-350m-7B_it-7B_en-hq-cx-14022024/data_prep-it-hq-job.err              # Name of stderr error file
...
~/llmfoundry-cuda-flash-attn2-env/bin/python scripts/data_prep/convert_dataset_json.py \
    --path /leonardo_work/IscrB_medit/culturax_res/reservoir_hq_85M/it \
    --out_root /leonardo_scratch/large/userexternal/rorland1/data/minestral-350m-7B_it-7B_en-cx-13022024/data/processed/it-hq/train \
