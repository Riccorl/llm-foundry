#!/bin/bash
#SBATCH --job-name=minestral-3b-test-21022024-train            # Job name
#SBATCH -o logs/minestral-3b-test-21022024/train-4nodes-job.out       # Name of stdout output file
#SBATCH -e logs/minestral-3b-test-21022024/train-4nodes-job.err       # Name of stderr error file
...
srun ./scripts/slurm/minestral-3b-test/train_multinode.sh
