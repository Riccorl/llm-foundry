#!/bin/bash
#SBATCH --job-name=mptua-1B-100B_it-100B_en-cx-18032024-16train            # Job name
#SBATCH -o logs/mptua-1B-100B_it-100B_en-cx-18032024/train-16job.out       # Name of stdout output file
#SBATCH -e logs/mptua-1B-100B_it-100B_en-cx-18032024/train-16job.err       # Name of stderr error file
...
srun ./scripts/slurm/mptua-1B-100B_it-100B_en-cx-18032024/train_multinode.sh
